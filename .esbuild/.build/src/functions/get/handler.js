...
var getonefromdb = async (body) => {
  const response = await DynamoDB2.get(body).promise();
  return response;
};

// src/functions/get/handler.ts
var getone = async (event) => {
  try {
    ...
    const response = await getonefromdb(request);

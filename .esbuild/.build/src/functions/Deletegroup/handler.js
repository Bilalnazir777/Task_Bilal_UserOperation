...
// src/functions/Deletegroup/handler.ts
var handler_exports = {};
...
var deletefromdb = async (body) => {
  const response = await DynamoDB2.delete(body).promise();
  return response;
};

// src/functions/Deletegroup/handler.ts
var DeleteGroup = async (event) => {
  try {
